...
/*
//Rico, Sarah, 991683075

Final Project

The program creates a game GUI datebase that
allows user to add, delete, edit or search for
a specific game.
...
public class Game {
  ...
  public String getNumberOfPlayers() {
    ...
    public String toString() {
        return "\n\nGame name: " + title + ":\n" + "Company:" + "(" + getCompany() + ")" + "\nConsole: " + getConsoles()
         + "\nPrice: " + getPrice() + "\nGenre: "+ getGenre() +  "\nStock: " + getStock() + "\nPlay time: "
          + getPlayTime() + "\nVr Support: " + getVrSupport() + "\nType: " + getType() + "\nRelease date: " + getReleaseDate()
            + "\nAdditional genre: " +  getAdditionalGenre() + "\nLanguages: " + getlanguageSupported() 
